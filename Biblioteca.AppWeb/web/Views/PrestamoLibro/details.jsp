...
<html>
    <head>
        ...
        <title>Detalle PrestamoLibro</title>
    </head>
    <body>
        <jsp:include page="/Views/Shared/headerBody.jsp" />  
        <main class="container">   
            <h5>Detalle PrestamoLibro </h5>
            <form action="PrestamoLibro" method="post">
                ...
                <div class="row">
                    <div class="col l12 s12">
                        <button type="sutmit" class="waves-effect waves-light btn blue"><i class="material-icons right">details</i>Detalle</button>
